...
- Base candidate: current API `main` at `7ee5a0a53a3434c3e00969dc626a4daad33f9dc0`; the implementation semantics are carried from `f2d643a0913b888809c217adfd9bdcef0385b05a` without transplanting its historical terminal tree.
...
- Consumer entrypoint: an explicit pin set plus field-level producer/consumer fixture for Luzione UI and Sultan OS; consumers adapt locally and must not fork or redefine the contracts.
...
3. Surplus, missing and wrong-version fields, actor/tenant/capability mismatches, cross-tenant receipt/readback, stale source finality, replay payload drift, effect-authority smuggling, command/receipt mismatch and acknowledgement-as-finality fixtures fail closed.
