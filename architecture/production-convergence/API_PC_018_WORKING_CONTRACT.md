# API-PC-018 Working Contract — Canonical License Store and Readback

Project: `API-PC-018` — add an append-versioned, tenant-scoped license and module-entitlement store plus authenticated readback while provisioning and billing effects remain disabled.
