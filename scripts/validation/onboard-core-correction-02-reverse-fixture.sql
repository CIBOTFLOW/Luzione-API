...
insert into public.onboarding_setup_mandate_revocations (
  tenant_id, revocation_event_id, mandate_id, revocation_ref, reason_code,
  actor_id, human_authentication_ref, revoked_at
) values (
  'tenant-reverse-proof',
  '33333333-3333-4333-8333-333333333333',
  '22222222-2222-4222-8222-222222222222',
  'mandate-revocation:reverse-proof',
  'SECURITY_HOLD',
  'user:reverse-proof',
  'supabase-session:reverse-proof',
