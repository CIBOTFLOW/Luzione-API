...
export const seedProcurementPositiveFixture = createSeedProcurementReadModel({
  ...
  bidComparisons: [],
  blockedDependencies: [
    { affectedCapabilities: ["rfq.create_draft", "supplier_quote.normalize"], code: "SUPPLIER_ELIGIBILITY_UNVERIFIED", requiredContract: "CanonicalSupplierEligibility/v1", summary: "Tenant Account identity does not attest supplier eligibility." },
  ...
  evidenceArtifacts: [evidenceArtifactFixture],
  productCandidates: [{ conflictRefs: [], duplicateOfCandidateId: null, extractionProvenance: ["fixture-parser:row-1"], fit: { ...objectiveFitFixture, score: 0.865 }, resource: productCandidateFixture }],
  productSources: [{ conflictRefs: [], duplicateOfSourceId: null, extractionProvenance: ["fixture-parser:v1"], ingestionFormat: "URL", resource: productSourceFixture }],
