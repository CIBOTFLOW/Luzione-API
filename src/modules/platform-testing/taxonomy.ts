...
export const testSuiteTaxonomy: readonly TestSuiteDescriptor[] = Object.freeze([
  ...
  { suitePath: "src/modules/sultan-agent-gateway/tests/sultan-internal-archive.test.ts", primaryClass: "RELIABILITY", secondaryClasses: ["SECURITY"], evidenceScope: "exact target archival, tenant/case/version boundaries, repeat archive and failed update" },
