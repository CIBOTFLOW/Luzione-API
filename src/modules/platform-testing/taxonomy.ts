...
export const testSuiteTaxonomy: readonly TestSuiteDescriptor[] = Object.freeze([
  ...
  { suitePath: "src/modules/connector-revocation/tests/connector-revocation-v2.test.ts", primaryClass: "SECURITY", secondaryClasses: ["CONTRACT", "INTEGRATION", "RELIABILITY"], evidenceScope: "CONNECTOR-REVOCATION-L1-CORRECTION-01 strict server-owned binding/account/credential-generation resolution, raw-digest, phased kill, append-only P110 and zero-effect emulator boundary" },
  ...
  { suitePath: "src/modules/operations-evidence-contracts/tests/operations-evidence-ledger-v2.test.ts", primaryClass: "CONTRACT", secondaryClasses: ["SECURITY", "RELIABILITY"], evidenceScope: "OPS-CONTRACTS-CORRECTION-01 v2 append-ledger content binding, prior-set supersession, typed references, proof clocks/resets, canonical human ownership, exact per-effect G2 authority, hard zeros and schema/SDK parity" },
  { suitePath: "src/modules/operations-evidence-contracts/tests/operations-evidence-ledger-v3.test.ts", primaryClass: "SECURITY", secondaryClasses: ["CONTRACT", "RELIABILITY"], evidenceScope: "OPS-CONTRACTS-CORRECTION-02 source-bound human membership, exact one-scope G2 approval, resolved-verified incident recovery, deterministic continuous epoch lineage, v1/v2 decision prohibition and zero-credit parity" },
