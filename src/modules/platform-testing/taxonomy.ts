...
export const testSuiteTaxonomy: readonly TestSuiteDescriptor[] = Object.freeze([
  ...
  { suitePath: "src/modules/connector-revocation/tests/connector-revocation.test.ts", primaryClass: "SECURITY", secondaryClasses: ["CONTRACT", "INTEGRATION", "RELIABILITY"], evidenceScope: "CONNECTOR-REVOCATION-L1-G0 strict append-only receipt, human authority, tenant/credential tuple, kill, replay, remote-finality and zero-effect emulator boundary" },
  ...
  { suitePath: "src/modules/seed-project-publication/tests/seed-project-publication.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "SEED-PROJECT-PUBLICATION-A2 strict Opportunity-to-Project, immutable Planner package, active Specification, pending revision, tenant/version/replay/atomicity/readback and known-bad controls" },
  { suitePath: "src/modules/seed-procurement/tests/seed-procurement.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "SEED-PROCUREMENT-A3 strict artifact/source/candidate persistence, objective scoring, tenant/version/replay/atomicity/readback, false-finality, known-bad controls, and fail-closed Supplier/Proposal dependency holds" },
  { suitePath: "src/modules/seed-supplier-identity/tests/seed-supplier-identity.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "SEED-SUPPLIER-IDENTITY-A2S Account-backed SupplierProfile eligibility, human approval, Portal access binding, exact version/receipt/Timeline readback, tenant/replay/concurrency/atomicity/RLS/rollback and no-effect controls" },
  { suitePath: "src/modules/seed-proposal-owner/tests/seed-proposal-owner.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "SEED-PROPOSAL-OWNER-A2P API-PC-009-backed immutable templates, typed CPQ economics, exact proposal revisions/client decisions, render preparation, canonical PO-draft admission, tenant/version/replay/atomicity/RLS and zero-effect controls" },
  ...
  { suitePath: "src/modules/luzione-core-contracts/tests/seed-product-contracts.test.ts", primaryClass: "CONTRACT", secondaryClasses: ["SECURITY", "RELIABILITY", "INTEGRATION"], evidenceScope: "SEED-PRODUCT-01 strict v1 flagship graph, tenant/source/version/idempotency/authority/receipt/readback invariants and provider-acknowledgement false-finality negatives" },
  ...
  { suitePath: "src/modules/effect-admission/tests/effect-admission.test.ts", primaryClass: "SECURITY", secondaryClasses: ["CONTRACT", "INTEGRATION", "RELIABILITY"], evidenceScope: "EFFECT-ADMISSION-L1 exact-tuple default-off authority, kill-version re-read, payload binding, opaque credential resolution and reconciliation-without-redispatch" },
  ...
  { suitePath: "src/modules/onboard-core/tests/blueprint-mandate.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "ONBOARD-CORE-CORRECTION-01 exact Tenant Pack schema/L2 binding, cryptographic distinct-human approval and append-only Mandate revocation" },
  { suitePath: "src/modules/onboard-core/tests/import-dry-run.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "ONBOARD-CORE-CORRECTION-01 L1-derived no-effect import outcomes, exact mapper/evidence binding and enforced job-runtime authority" },
  { suitePath: "src/modules/onboard-core/tests/connector-validation.test.ts", primaryClass: "INTEGRATION", secondaryClasses: ["CONTRACT", "SECURITY", "RELIABILITY"], evidenceScope: "ONBOARD-CORE-FINAL-ASSURE-01 active Mandate connector admission and closed matching-readback/pending/typed-non-success outcome logic" },
