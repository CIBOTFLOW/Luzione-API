...
export const testSuiteTaxonomy: readonly TestSuiteDescriptor[] = Object.freeze([
  ...
  { suitePath: "src/modules/productization/tests/productization.test.ts", primaryClass: "CONTRACT", secondaryClasses: ["SECURITY", "INTEGRATION"], evidenceScope: "premium-home-goods product catalog, fail-closed licensing and room-plan proposal attachment" },
