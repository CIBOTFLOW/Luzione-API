...
export const testSuiteTaxonomy: readonly TestSuiteDescriptor[] = Object.freeze([
  ...
  { suitePath: "src/modules/linked-evidence-context/tests/linked-evidence-context.test.ts", primaryClass: "CONTRACT", secondaryClasses: ["SECURITY", "RELIABILITY"], evidenceScope: "bounded Task/Commercial Case/Quote/Product/Supplier linked evidence, exact record/version citations and explicit missing/denied/stale recovery states" },
  { suitePath: "src/modules/authorization-proof/tests/sgo-v02-authorization.test.ts", primaryClass: "SECURITY", secondaryClasses: ["CONTRACT", "RELIABILITY"], evidenceScope: "credential-grounded service actor/tenant/object authorization, cache-release isolation and explicit end-user/cross-repository holds across context, attachment, action, thread and export surfaces" },
  ...
  { suitePath: "src/modules/platform-topology/tests/sgo-c01-active-path-inventory.test.ts", primaryClass: "CONTRACT", secondaryClasses: ["INTEGRATION", "SECURITY"], evidenceScope: "exact-pinned Sultan surface runtime-producer and canonical-source ownership inventory" },
