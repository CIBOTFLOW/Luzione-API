...
export const sourceOfTruthRegistry: readonly SourceOfTruthDescriptor[] = Object.freeze([
  ...
  {
    canonicalStoreOrProvider: "canonical-postgres",
    conflictStrategy: "Reject stale record versions; only one exact_version_current license may exist per tenant.",
    ...
    mutationOwner: "CIBOTFLOW/Luzione-API",
    ownershipState: "CONFIRMED",
    readModels: ["public.tenant_product_license_versions"],
    rebuildable: false,
    reconciliationStrategy: "A future billing adapter must append an exact version and reconcile provider source status before superseding the current version.",
    retention: "policy pending commercial and compliance decision",
    semanticOwner: "CIBOTFLOW/Luzione-API",
    versionIdentifier: "license_id plus record_version plus content_digest",
  },
  {
    canonicalStoreOrProvider: "canonical-postgres",
    conflictStrategy: "Entitlements bind one exact license version; unknown modules and access modes fail closed.",
    consistency: "TRANSACTIONAL",
    domain: "licensing",
    ...
    mutationOwner: "CIBOTFLOW/Luzione-API",
    ownershipState: "CONFIRMED",
    readModels: ["public.tenant_product_module_entitlements"],
    rebuildable: false,
    reconciliationStrategy: "Read through the current exact license version; provider or operator changes create a new version and controlled supersession rather than editing commercial fields in history.",
    retention: "inherits TenantLicense policy",
    semanticOwner: "CIBOTFLOW/Luzione-API",
    versionIdentifier: "license_version_id plus module_id",
  },
  {
