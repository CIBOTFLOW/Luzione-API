export const controlPlaneOpenApi = {
  ...
  paths: {
    ...
    "/commands/{commandId}/learning-transition": {
      post: {
        operationId: "applyLearningTransition",
        parameters: [{ $ref: "#/components/parameters/commandId" }],
        responses: {
          "200": { description: "Atomic verified learning transition with zero external effects" },
          "403": { description: "Actor, policy, guardian, or membership capability denied" },
          "409": { description: "Stale transition or idempotency conflict" },
        },
      },
    },
    "/models/catalog": {
