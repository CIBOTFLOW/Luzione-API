...
test("contract v0.1 manifest and JSON-compatible OpenAPI publish the same bounded release", () => {
  ...
  assert.deepEqual(Object.keys(openApi.paths).sort(), [
    ...
    "/api/v1/connectors/sync-validations",
    "/api/v1/healthz",
    "/api/v1/livez",
    "/api/v1/onboarding/imports/dry-runs",
    "/api/v1/onboarding/imports/{batchId}",
    "/api/v1/onboarding/setup-mandates",
    "/api/v1/onboarding/tenant-blueprints",
    "/api/v1/onboarding/tenant-blueprints/approvals",
