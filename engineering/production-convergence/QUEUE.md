...
This is a non-authoritative human view. The only live scheduler is `engineering/execution/NEXT_WORK.json`; update and select work there. API-PC-001 through API-PC-015 were admitted from the 2026-08-30 production-convergence charter.
...
| API-PC-015 | PLANNED | API-PC-001 through API-PC-014 |
