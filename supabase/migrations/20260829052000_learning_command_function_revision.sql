...
-- Validation first received the adapter before the local receipt variable was
-- disambiguated. Reinstall the final definition so restored clones and fresh
-- projects converge on the same fail-on-ambiguity implementation.
