...
The machine-readable bundle is `contracts/drafts/luzione-shared-contracts-v0.2-draft.1.manifest.json`. The executable producer adapters are `src/modules/shared-contract-drafts/contracts.ts` and `src/modules/shared-contract-drafts/adapters.ts`.
